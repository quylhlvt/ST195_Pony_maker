...
private var View.lastClickTime: Long
    get() = (getTag(1766613358) as? Long) ?: 0
    set(value) = setTag(1766613358, value)

fun View.setClick(interval: Long = 500L, block: (View) -> Unit) {
...
// ----------------------------
//fun View.tap(interval: Long = 500, action: (View) -> Unit) {
//    setOnClickListener {
